...
<div class="equipment-type-form">
    ...
    $items = ArrayHelper::map($equipmentSystem, 'uuid', 'title');
    echo $form->field($model, 'equipmentSystemUuid',
        ['template' => MainFunctions::getAddButton("/equipment-system/create")])->widget(Select2::class,
        [
            'data' => $items,
            'language' => 'ru',
            'options' => [
